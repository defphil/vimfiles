...
" Default group
hi Cursor ctermfg=236 ctermbg=231 cterm=NONE guifg=#2d2a2e guibg=#20ff20 gui=NONE
...
hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=#000000 guibg=#ffeb27 gui=underline
...
hi Normal ctermfg=231 ctermbg=236 cterm=NONE guifg=#fcfcfa guibg=#1d1a1e gui=NONE
...
hi Todo ctermfg=231 ctermbg=NONE cterm=inverse,bold guifg=#fcfcfa guibg=NONE gui=inverse,bold
